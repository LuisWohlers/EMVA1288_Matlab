function [SNR_max,DR,fig] = plot_SNR_2(input,mean_dark,photonsperstep,p_min,p_sat,e_sat,temp_dark_noise,var_quantisation,K,quantum_efficiency,DSNU,PRNU)
...
xlim([p_min-10 p_sat+0.1*10^(round(log10(p_sat)))]);
